...
const Footer = () => {
  return (
    <footer className=" w-[90%] mx-auto  max-w-6xl 2xl:max-w-7xl mb-6 ms:mb-8 rounded-[16px] md:mb-16 bg-[#161C2D] py-16 px-4 md:px-[70px] pt-[70px] 2xl:pt-[90px]">
      <div className="flex flex-col lg:flex-row gap-8 items-start px-3 md:px-0  md:items-center justify-between pb-16 border-b border-gray-600">
        <div className="flex flex-col items-center lg:items-start max-w-lg gap-3">
          <h2 className=" text-3xl mb-8 md:mb-6 text-center lg:text-start md:text-3xl  text-white font-semibold">
            Ready to launch your next project?
          </h2>
          <p className=" text-gray-400 2xl:text-lg text-center lg:text-start my-2 md:my-0 leading-loose md:leading-6 tracking-wide">
        ...
        <Link
          ...
          className=" bg-[#7165FF] mx-auto md:mx-0 w-full text-center lg:w-fit rounded-[8px] text-white py-5 px-6 2xl:px-12  2xl:text-lg"
        >
