...
const TestimonialModal = ({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className=" overflow-hidden max-h-[85svh] md:max-h-[90svh] md:min-w-[900px] 2xl:min-w-[1000px] bg-gradient-to-r from-[#900EF7] flex flex-col items-center  md:flex-row  gap-6 md:gap-12 2xl:gap-20  to-[#D677FE] pb-0 px-12 pt-20 md:p-20 border-none ">
